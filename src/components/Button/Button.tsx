...
const buttonVariants = cva(
  "inline-flex items-center justify-center font-medium rounded-md text-sm transition-colors disabled:bg-grey-100 disabled:text-grey-300 disabled:pointer-events-none disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
